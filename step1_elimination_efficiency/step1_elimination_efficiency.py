...
try:
    for index, row in final_df[2254:2500].iterrows():
        free_text = row['text']
...
llm_2254_2500_step1 = pd.DataFrame({'index': index_list, 'llm_2254_2500_step1': llm_response_list})

with open('llm_2254_2500_step1.pkl', 'wb') as file:
    pickle.dump(llm_2254_2500_step1, file)
