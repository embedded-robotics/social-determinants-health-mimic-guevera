...
try:
    for index, row in final_df[5293:5321].iterrows():
        free_text = row['text']
...
llm_5293_5321_step1 = pd.DataFrame({'index': index_list, 'llm_5293_5321_step1': llm_response_list})

with open('llm_5293_5321_step1.pkl', 'wb') as file:
    pickle.dump(llm_5293_5321_step1, file)
