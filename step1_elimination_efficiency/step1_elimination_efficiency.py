...
try:
    for index, row in final_df[4500:5000].iterrows():
        free_text = row['text']
...
llm_4500_5000_step1 = pd.DataFrame({'index': index_list, 'llm_4500_5000_step1': llm_response_list})

with open('llm_4500_5000_step1.pkl', 'wb') as file:
    pickle.dump(llm_4500_5000_step1, file)
